...
public class RadixSort {
    ...
    public static void contador_de_frequencia(int[] array, int divisor) {
        ...
        * Agora, o dígito 0 começa na posição 0, e o próximo dígito (1) começará na posição 0.
        *
        * Iteração 2 (i = 1):
        * Frequência: contagem[1] = 3.
        * Posição inicial: contagem[1] = 0.
        * Atualiza acumulador: 0 + 3 = 3.
        * Agora, o dígito 1 começa na posição 0, e o próximo dígito (2) começará na posição 3.
        *
        * Iteração 3 (i = 2):
        * Frequência: contagem[2] = 0.
        * Posição inicial: contagem[2] = 3.
        * Atualiza acumulador: 3 + 0 = 3.
        * Agora, o dígito 2 começa na posição 3, e o próximo dígito (3) começará na posição 3.
        *
    ...
    public static void main(String[] args) {
        ...
        int[] numeros = {123, 321, 543, 1, 89, 1, 324, 77, 123};
